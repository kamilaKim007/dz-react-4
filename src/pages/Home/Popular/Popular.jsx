    ...
    <popular className='popular'>
        <div className="container">
            ...
            <div className="popular__scroll">
                <div className="popular__left-arrow">
                    <svg width="90" height="90" viewBox="0 0 90 90" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="45" cy="45" r="45" fill="white"/>
                    <path d="M53 26L37 45.5L53 65" stroke="#254A5A"/>
                    </svg>
                </div>
                <div className="popular__products">
                    <img src={Images1} alt="" />
                    <h2 className='popular__products-title'>REPlay</h2>
                    <p className='popular__products-name'> Classic shoes</p>
                    <span className='popular__products-price'>6100 UAH</span>
                    <span className='popular__products-uaprice'>3800 UAH</span>
                </div>
                <div className="popular__products">
                    <img src={Images2} alt="" />
                    <h2 className='popular__products-title'>REPlay</h2>
                ...
                <div className="popular__right-arrow">
                    <svg width="90" height="90" viewBox="0 0 90 90" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="45" cy="45" r="45" fill="white"/><path d="M37 26L53 45.5L37 65" stroke="#254A5A"/>
                    </svg>
                </div>
            </div>
            <div className='popular__allegory'>
                <div className='popular__allegory-lines'></div>
                <div className='popular__allegory-svg'>
                    <svg className='popular__allegory-logo' width="115" height="14" viewBox="0 0 115 14" fill="none" xmlns="http://www.w3.org/2000/svg">
